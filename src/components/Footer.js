        ...
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li><Link href="/rooms" className="text-ink hover:text-accent-dark">Browse rooms</Link></li>
              <li><Link href="/register" className="text-ink hover:text-accent-dark">List your room</Link></li>
              <li><Link href="/dashboard" className="text-ink hover:text-accent-dark">Owner dashboard</Link></li>
            </ul>
          </div>
          <div>
